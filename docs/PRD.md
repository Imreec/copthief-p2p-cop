...
> `docs/REVIEW_PROCESS.md`.** **This copy: the police (cop) repo — lead repo; ⚑ sections apply
> as POLICE.** Sibling: [copthief-p2p-thief](https://github.com/Imreec/copthief-p2p-thief).
> Per-mechanism
